...
public class LanguageSelector extends JPanel {
    ...
    public LanguageSelector(MainFrame parent) {
        ...
        flagsPanel.setBackground(new Color(255, 255, 255));
        flagsPanel.setForeground(new Color(255, 255, 255));
        flagsPanel.setLayout(new GridLayout(0, numberOfLanguages + 2));
        GroupLayout layout = new GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addComponent(flagsPanel, GroupLayout.DEFAULT_SIZE, 674, Short.MAX_VALUE)
        );
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        flagsPanel = new JPanel();
        flagsPanel.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
    }
